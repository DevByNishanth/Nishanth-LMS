...
const COLORS = ["#34B3F1", "#08384F", "#0B56A4", "#0B57A4"];
...
export default function StudentManagementPieChart({
  isAnimationActive = true,
}) {

  const [loading, setLoading] = useState(true);
const chartData = [
  { name: "First Year", value: 230 },
  { name: "Second Year", value: 234 },
  { name: "Third Year", value: 350 },
  { name: "Fourth Year", value: 350 },
];
  ...
  const legends = [
    { color: "#34B3F1", label: "1st year" },
    { color: "#0B56A4", label: "2nd year" },
    { color: "#08384F", label: "3rd year" },
    { color: "#08394F", label: "4th year" },
  ];
